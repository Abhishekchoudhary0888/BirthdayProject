...
const InputComponent = rewire("./InputComponent")
const mapStateToProps = InputComponent.__get__("mapStateToProps")
const mapDispatchToProps = InputComponent.__get__("mapDispatchToProps")
// @ponicode
